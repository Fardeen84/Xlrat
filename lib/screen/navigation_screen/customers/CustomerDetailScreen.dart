...
class _CustomerDetailScreenState extends ConsumerState<CustomerDetailScreen> {
  ...
  void _showDeleteConfirmationDialog(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(
          'Are you sure you want to delete ${customer.name}? This will also delete all their vehicles and invoices.',
          style: TextStyle(color: kForeground),
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    ...
    final invoicesAsync = ref.watch(
      invoicesByCustomerProvider(widget.customerId),
    );
    final invoices = invoicesAsync.value ?? [];

    final vehiclesAsync = ref.watch(
      vehiclesForCustomerProvider(widget.customerId),
    );
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        children: [
                                          _chip(
                                            '$uniqueVehiclesCount Vehicle${uniqueVehiclesCount == 1 ? '' : 's'}',
                                          ),
                      ...
                      if (_tabIndex == 0) ...[
                        ...
                        if (vehiclesList.isEmpty)
                          EmptyStateView(
                            ...
                            description:
                            'Add vehicles for this customer to map them to invoices and job cards.',
                          ...
                          data: (invoicesList) {
                            if (invoicesList.isEmpty) {
                              return EmptyStateView(
                                ...
                                description:
                                'Create an invoice to bill this customer for parts and services.',
                                      ...
                                      children: [
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            const SizedBox(height: 2),
                                            Text(
                                              '${DateFormat('dd MMM yyyy').format(inv.invoiceDate)} · ${inv.vehicle?.vehicleBrand ?? ''} ${inv.vehicle?.vehicleModel ?? ''}'
                                                  .trim(),
                                              style: TextStyle(
                                                fontSize: 11,
                                                color: kMutedForeground,
                          ...
                          data: (invoicesList) {
                            if (invoicesList.isEmpty) {
                              return const EmptyStateView(
                                ...
                                title: 'No History',
                                description:
                                'Service timeline history will appear here once invoices are created.',
                              );
                            }
                            return Column(
